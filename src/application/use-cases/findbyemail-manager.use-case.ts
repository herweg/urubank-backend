...
export class FindByEmailManagerUseCase<
  Command extends IFindByEmailManagerCommand = IFindByEmailManagerCommand,
...
> {
  ...
  private executeInvoiceAggregateRoot(
    ...
    return this.managersService.findByEmail(command.email);
  }
}
