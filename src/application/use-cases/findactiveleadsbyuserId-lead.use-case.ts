...
export class FindActiveLeadsByUserIdLeadUseCase<
  Command extends IFindActiveLeadsByUserIdLeadCommand = IFindActiveLeadsByUserIdLeadCommand,
...
> {
  ...
  private executeInvoiceAggregateRoot(
    ...
    return this.leadsService.findActiveLeadsByUserId(command.userId);
  }
}
