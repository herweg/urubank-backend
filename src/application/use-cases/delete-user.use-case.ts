...
export class DeleteUserUseCase<
  Command extends IDeleteUserCommand = IDeleteUserCommand,
...
> {
  ...
  /**
   * It calls the `remove` function of the `UsersService` and returns the result
  ...
  private executeInvoiceAggregateRoot(
    ...
    return this.usersService.remove(command.id);
  }
}
