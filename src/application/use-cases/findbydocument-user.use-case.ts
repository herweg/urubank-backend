...
export class FindByDocumentUserUseCase<
  Command extends IFindByDocumentUserCommand = IFindByDocumentUserCommand,
...
> {
  ...
  private executeInvoiceAggregateRoot(
    ...
    return this.usersService.findByDocument(command.document);
  }
}
